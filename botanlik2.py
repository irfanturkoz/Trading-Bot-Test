...
def main():
    ...
    print("\nESC'ye basarak çıkabilirsiniz. Tarama her 10 dakikada bir otomatik tekrar edecek.")
    ...
    while True:
        ...
        if all_firsatlar:
            ...
            if all_firsatlar_08:
                ...
                print('⏰ 10 dakika sonra tekrar taranacak...')
        ...
        print("\n⏰ Enter'a basarak hemen tekrar tarama yapın, ESC'ye basarak çıkın veya 10 dakika bekleyin...")
        ...
        while True:
            ...
            if elapsed_time >= timeout:
                print("\n🔄 10 dakika doldu, otomatik tarama yapılıyor...")
                break
    ...
    try:
        ...
        for symbol in symbols:
            try:
                ...
                if result:
                    firsatlar.append(result)
                    print(f"✅ {symbol}: {result['formasyon']} - R/R: {result.get('rr_ratio', 0):.2f}")
        ...
        all_firsatlar = sorted(firsatlar, key=lambda x: x.get('tpfark', 0), reverse=True)[:10]
